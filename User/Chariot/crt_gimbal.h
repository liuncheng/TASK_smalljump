 ...
 *
 */
class Class_Gimbal_Pitch_Motor_C620 : public Class_DJI_Motor_C620
{
public:
    // 陀螺仪获取云台角速度
    Class_IMU *IMU;
...
protected:
    ...
    // 重力补偿
    float Gravity_Compensate = 5000.0f;
...
float Class_Gimbal_Pitch_Motor_C620::Get_True_Rad_Pitch()
{
    return (True_Rad_Pitch);
}

float Class_Gimbal_Pitch_Motor_C620::Get_True_Angle_Pitch()
{
    return (True_Angle_Pitch);
}

float Class_Gimbal_Pitch_Motor_C620::Get_True_Gyro_Pitch()
{
    return (True_Gyro_Pitch);
}
...
public:
    ...
    Class_Gimbal_Pitch_Motor_C620 Joint_Left;
    Class_Gimbal_Pitch_Motor_C620 Joint_Right;

    // Class_LK_Motor lkmotor[4];
