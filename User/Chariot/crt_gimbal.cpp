 ...
 *
 */
void Class_Gimbal_Pitch_Motor_C620::TIM_PID_PeriodElapsedCallback()
{
    switch (DJI_Motor_Control_Method)
    {
    case (DJI_Motor_Control_Method_OPENLOOP):
    {
        // 默认开环速度控制
        // Set_Out(Target_Omega_Angle /  * Output_Max);
    }
    break;
    case (DJI_Motor_Control_Method_TORQUE):
    {
 ...
 *
 */
void Class_Gimbal_Pitch_Motor_C620::Transform_Angle()
{
...
void Class_Gimbal::Init()
{
    ...
    // 关节
    Joint_Left.PID_Angle.Init(45, 0, 0, 0, 16384, 16384);
    Joint_Left.PID_Omega.Init(120, 0, 0.1, 0, 15000, 16384);
    Joint_Left.IMU = &Boardc_BMI;
    Joint_Left.Init(&hcan1, DJI_Motor_ID_0x201, DJI_Motor_Control_Method_IMU_ANGLE, 19);

    Joint_Right.PID_Angle.Init(35, 0, 0, 0, 16384, 16384);
    Joint_Right.PID_Omega.Init(120, 0, 0.1, 0, 15000, 16384);
    Joint_Right.IMU = &Boardc_BMI;
    Joint_Right.Init(&hcan1, DJI_Motor_ID_0x202, DJI_Motor_Control_Method_IMU_ANGLE, 19);
}
...
void Class_Gimbal::Output()
{
    if (Gimbal_Control_Type == Gimbal_Control_Type_DISABLE)
    {
        ...
        Joint_Left.Set_Target_Angle(Target_Pitch_Angle);
        Joint_Right.Set_Target_Angle(Target_Pitch_Angle);
    }
    else // 非失能模式
    {
        ...
        Joint_Left.Set_DJI_Motor_Control_Method(DJI_Motor_Control_Method_IMU_ANGLE);
        Joint_Right.Set_DJI_Motor_Control_Method(DJI_Motor_Control_Method_IMU_ANGLE);
...
void Class_Gimbal::TIM_Calculate_PeriodElapsedCallback()
{
    ...
    Joint_Left.Transform_Angle();
    Joint_Right.Transform_Angle();
    ...
    Joint_Left.TIM_PID_PeriodElapsedCallback();

    Joint_Right.Data.Now_Angle = -Joint_Right.Data.Now_Angle;
    Joint_Right.Data.Now_Omega_Angle = -Joint_Right.Data.Now_Omega_Angle;

    Joint_Right.TIM_PID_PeriodElapsedCallback();

    Joint_Right.Set_Out(-Joint_Right.Get_Out());
    Joint_Right.Output();
}
